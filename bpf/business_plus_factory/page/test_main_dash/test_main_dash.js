frappe.pages['test-main-dash'].on_page_load = function(wrapper) {

	var page = frappe.ui.make_app_page({

		parent: wrapper,

		title: 'Test Main Dashboard',
    ...
    page.main.html(frappe.render_template('test_main_dash'));

	frappe.require(['/assets/ssp_theme/repository/js/vendor/highcharts/highcharts.js', 

    '/assets/ssp_theme/repository/js/vendor/highcharts/modules/exporting.js', 

    '/assets/ssp_theme/js/charts.js',

    '/assets/ssp_theme/js/main.js'
        ...
        function get_chart_from_erpnext_doctype_dashboard_api(c_args, chart_id, c_type) {
            ...
            frappe.call({
                 ...
                 method: 'ssp_theme.ssp_theme.page.main_dashboard.main_dashboard.has_permission',
       ...
       $("#"+chart_id).parent().parent().css('display',"none");
         ...
         function get_chart_from_custom_api(chart_id, id) {
             ...
             frappe.call({
                 ...
                 method: 'ssp_theme.apis.home_dashboard_apis.get_chart_data',
