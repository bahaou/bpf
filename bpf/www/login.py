...
def get_context(context):
	...
	context["logo"]= frappe.get_doc("Website Settings").app_logo or frappe.get_hooks("app_logo_url")[-1]
	context["background"] = frappe.get_doc("Website Settings").background_logo  or "" 
	context["app_name"] = (
